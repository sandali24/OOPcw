...
//            JTable table = new JTable(model); // Create a table with the data and column names
//            JScrollPane scrollPane = new JScrollPane(table); // Create a scroll pane to hold the table
//            panel1.add(scrollPane); // Add the scroll pane to the first panel
...
//            double[] totalCost = shoppingCartObj.calculateTotalCost(productsInCart);
//
//            panel2.add(new JLabel("Total: "+ "" +" " + totalCost[0]));
//            panel2.add(new JLabel("First Purchase Discount (10%): - 8.58 €"));
//            panel2.add(new JLabel("Three Items in the Same Category Discount (20%): " + " "+ " " + totalCost[2]));
//            panel2.add(new JLabel("Final Total: "+ " "+ " "+ totalCost[1]));
